...
main (int argc, char *argv[])
{
  ...
  //-----------------------------------------------------
  rdTrace.open("tcpWireless1Sink.dat", std::ios::out);
  ...
  wifiPhy.EnableAsciiAll (ascii.CreateFileStream("tcpWireless1Sink.tr"));
  wifiPhy.EnablePcapAll("tcpWireless1Sink");
  ...
  Simulator::Run ();
  flowMonitor->SerializeToXmlFile("tcpWireless1Sink.xml", true, true);
  Simulator::Destroy ();
