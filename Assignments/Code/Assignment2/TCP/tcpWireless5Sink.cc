...
main (int argc, char *argv[])
{
  ...
  //-----------------------------------------------------
  rdTrace.open("tcpWireless5Sink.dat", std::ios::out);
  ...
  wifiPhy.EnableAsciiAll (ascii.CreateFileStream("tcpWireless5Sink.tr"));
  wifiPhy.EnablePcapAll("tcpWireless5Sink");
  ...
  Simulator::Run ();
  flowMonitor->SerializeToXmlFile("tcpWireless5Sink.xml", true, true);
  Simulator::Destroy ();
