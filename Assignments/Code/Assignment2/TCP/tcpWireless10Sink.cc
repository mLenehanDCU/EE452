...
main (int argc, char *argv[])
{
  ...
  //-----------------------------------------------------
  rdTrace.open("tcpWireless10Sink.dat", std::ios::out);
  ...
  wifiPhy.EnableAsciiAll (ascii.CreateFileStream("tcpWireless10Sink.tr"));
  wifiPhy.EnablePcapAll("tcpWireless10Sink");
  ...
  Simulator::Run ();
  flowMonitor->SerializeToXmlFile("tcpWireless10Sink.xml", true, true);
  Simulator::Destroy ();
